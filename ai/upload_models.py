...
MODELS = [
    ...
    {
        "filename": "route_optimizer_clf.pkl",
        "path": os.path.join(os.path.dirname(__file__), "models", "route_optimizer", "route_optimizer_clf.pkl"),
        "root_fallback": os.path.join(os.path.dirname(__file__), "route_optimizer_clf.pkl")
    },
    {
